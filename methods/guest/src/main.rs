...
fn main() {
    ...
    println!(
        "loading data = {}",
        count_after_loading - count_before_loading
    );
    println!("hashing = {}", count_after_hashing - count_before_hashing);
    println!("building the z series = {}", count_after_z - count_before_z);
    println!(
        "computing az, bz, kz, nz = {}",
        count_after_a_b_k_n - count_before_a_b_k_n
    );
    println!(
        "computing cz, knz = {}",
